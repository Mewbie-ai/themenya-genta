<div id="kopa-admin-wrapper" class="theme-option clearfix">
    <form name="kopa-theme-options" id="kopa-theme-options" autocomplete="off" method="post" action="options.php">
        <?php settings_fields('kopa_theme_options_group'); ?>
        ...
        <div class="kopa-content">
            ...
            <div class="kopa-actions clearfix">
                <div class="kopa-button">
                    <div class="kopa-button">
                        <button type="submit" class="btn btn-primary"><i class="icon-ok-circle"></i><?php _e('Save', kopa_get_domain()); ?></button>
                    </div>
                </div>
