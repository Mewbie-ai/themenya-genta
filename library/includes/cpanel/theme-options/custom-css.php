<div id="tab-custom-css" class="kopa-content-box tab-content tab-content-1">    
    ...
    <div class="kopa-box-body">
        ...
        <div class="kopa-element-box kopa-theme-options">        
            ...
            <textarea class="" rows="10" id="kopa_custom_css" name="kopa_theme_options[kopa_theme_options_custom_css]"><?php echo esc_html( esc_textarea( kopa_get_option('kopa_theme_options_custom_css') ) ); ?></textarea>
